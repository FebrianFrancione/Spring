...
public class MyDemoLoggingAspect {
    ...
    @Around("execution(* com.demo.aroundWithLogger.service.*.getFortune(..))")
    ...
    @After("execution(* com.demo.aroundWithLogger.Dao.AccountDao.findAccounts(..))")
    ...
    @AfterThrowing(pointcut = "execution(* com.demo.aroundWithLogger.Dao.AccountDao.findAccounts(..))", throwing = "theExc")
    ...
    @AfterReturning(pointcut = "execution(* com.demo.aroundWithLogger.Dao.AccountDao.findAccounts(..))", returning = "result")
